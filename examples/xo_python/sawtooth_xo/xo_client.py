...
from examples.xo_python.sawtooth_xo.xo_exceptions import XoException
...
class XoClient:
    ...
    def create(self, name, wait=None, auth_user=None, auth_password=None):
        """
        Set the arguments for calling _send_xo_txn for Create
        """
    ...
    def delete(self, name, wait=None, auth_user=None, auth_password=None):
        """
        Set the arguments for calling _send_xo_txn for Delete
        """
        return self._send_xo_txn(
            name,
            "delete",
    ...
    def take(self, name, space, wait=None, auth_user=None, auth_password=None):
        """
        Set the arguments for calling _send_xo_txn for Take
        """
        return self._send_xo_txn(
            name,
            "take",
    ...
    def list(self, auth_user=None, auth_password=None):
        ...
        """
        xo_prefix = self._get_prefix()  # Get the XO Prefix, Not sure if we need it for us
    ...
    def _send_xo_txn(self, name, action, space="", wait=None, auth_user=None, auth_password=None):
