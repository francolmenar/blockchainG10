...
from examples.xo_python.sawtooth_xo.processor.handler import XoTransactionHandler
from examples.xo_python.sawtooth_xo.processor.config.xo import XOConfig
from examples.xo_python.sawtooth_xo.processor.config.xo import \
...
def main(args=None):
    ...
    try:
        ...
        processor = TransactionProcessor(url=xo_config.connect)  # Processor
        ...
        handler = XoTransactionHandler()  # handler
