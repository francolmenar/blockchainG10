...
from examples.xo_python.sawtooth_xo.processor.xo_payload import XoPayload
from examples.xo_python.sawtooth_xo.processor.xo_state import Game
from examples.xo_python.sawtooth_xo.processor.xo_state import XoState
from examples.xo_python.sawtooth_xo.processor.xo_state import XO_NAMESPACE
...
class XoTransactionHandler(TransactionHandler):
    ...
    def apply(self, transaction, context):
        ...
        xo_payload = XoPayload.from_bytes(transaction.payload)  # Set the Payload from the transaction

        xo_state = XoState(context)  # Set the State of the transaction
        ...
        if xo_payload.action == 'delete':
            ...
            xo_state.delete_game(xo_payload.name)  # Trigger the action
