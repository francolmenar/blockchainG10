...
if os.path.exists("tests"):
    data_files.append(('/data/tests/cert', ['tests/test_tp_cert.py']))
    data_files.append(('/data/tests/cert', [
        '../../tests/sawtooth_integration/tests/test_cert_smoke.py']))
...
setup(
    name='sawtooth-cert-tests',
    version=VERSION,
    description='Sawtooth CERT Python Test',
