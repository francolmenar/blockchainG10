...
from sawtooth_cert.cert_message_factory import CertMessageFactory


LOGGER = logging.getLogger(__name__)


class TestCert(TransactionProcessorTestCase):
    @classmethod
    def setUpClass(cls):
        super().setUpClass()

        cls.player_1 = CertMessageFactory()
        cls.public_key_1 = cls.player_1.get_public_key()

        cls.player_2 = CertMessageFactory()
